...
const LuxuryHero = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-blue-50 via-white to-indigo-50 text-gray-900">
      {/* Hero Section */}
      <div className="container mx-auto px-4 pt-20 pb-16 relative z-10">
        ...
        >
          ...
          >
            ...
            pawn jewellers. Streamline your operations with our premium software
            suite.
          </motion.p>
      ...
      <div className="bg-gradient-to-b from-indigo-50 to-white py-16 px-6">
